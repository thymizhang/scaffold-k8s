package com.ylwq.scaffold.service.company.config;

import com.ylwq.scaffold.service.company.component.ResourceAuthExceptionEntryPoint;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                .antMatchers("/api/company/**").access("#oauth2.hasAnyScope('scaffold','scaffold_admin')")
                .and()
